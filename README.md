...
### 핵심 시스템
- 🎯 **[실시간 게임 엔진](./backend/services/game_engine.py)** - WebSocket 기반 멀티플레이어 게임 로직
- 📚 **[단어 검증 시스템](./backend/services/word_validator.py)** - 10,794개 끄투 DB 활용 한국어 단어 검증
- 🎮 **[아이템 시스템](./backend/services/item_service.py)** - 5가지 희귀도의 전략적 아이템 관리
- 🔗 **[WebSocket 연결 관리](./backend/websocket/connection_manager.py)** - 실시간 통신 및 자동 재연결
