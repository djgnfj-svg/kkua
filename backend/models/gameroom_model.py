...
class Gameroom(Base):
    ...
    status = Column(String, nullable=False, default=GameStatus.WAITING.value)  # Enum.value로 저장
...
class GameroomParticipant(Base):
    ...
    status = Column(String, nullable=False, default=ParticipantStatus.WAITING.value)  # Enum.value로 저장
