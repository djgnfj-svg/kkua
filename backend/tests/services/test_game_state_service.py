...
class TestGameStateService:
    ...
    def test_start_game_exception(
        self, game_state_service, mock_db, mock_repository, sample_room
    ):
    ...
    def test_check_all_ready_success(
        self, game_state_service, mock_repository, sample_room
    ):
        ...
        participants = [
            Mock(
                guest_id=1, is_creator=True, status=ParticipantStatus.READY.value
            ),  # Creator
            Mock(
                guest_id=2, is_creator=False, status=ParticipantStatus.READY.value
            ),  # Ready participant
        ]
    ...
    def test_check_all_ready_not_all_ready(
        self, game_state_service, mock_repository, sample_room
    ):
        ...
        participants = [
            ...
            Mock(
                guest_id=3, is_creator=False, status=ParticipantStatus.WAITING.value
            ),  # Not ready
        ]
        mock_repository.find_room_participants.return_value = participants
    ...
    def test_check_all_ready_no_participants(
        self, game_state_service, mock_repository, sample_room
    ):
    ...
    def test_check_all_ready_exception(
        self, game_state_service, mock_repository, sample_room
    ):
    ...
    def test_can_start_game_success(
        ...
        mock_repository.find_by_id.return_value = sample_room
        mock_repository.find_room_participants.return_value = [
            Mock(),
            Mock(),
        ]  # 2 participants
    ...
    def test_can_start_game_not_host(
        self, game_state_service, mock_repository, sample_room
    ):
    ...
    def test_can_start_game_already_playing(
        self, game_state_service, mock_repository, sample_room
    ):
    ...
    def test_can_start_game_not_all_ready(
        self, game_state_service, mock_repository, sample_room
    ):
    ...
    def test_can_end_game_not_host(
        self, game_state_service, mock_repository, sample_room
    ):
    ...
    def test_can_end_game_not_playing(
        self, game_state_service, mock_repository, sample_room
    ):
