...
class TestGameInitialization:
    ...
    async def test_create_game_success(self, redis_service, sample_participants):
        ...
        result = await redis_service.create_game(room_id, sample_participants, max_rounds)
...
class TestWordSubmission:
    ...
    @pytest.mark.asyncio
    async def test_submit_word_invalid_start_character(self, redis_service, sample_game_state):
