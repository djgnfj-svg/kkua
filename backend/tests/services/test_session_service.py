...
class TestSessionStore:
    ...
    def test_get_session_expired(self, session_store):
        ...
        session_store.sessions[token]['expires_at'] = datetime.utcnow() - timedelta(seconds=1)
    ...
    def test_cleanup_expired_sessions(self, session_store):
        ...
        # Expire one session
        session_store.sessions[token1]['expires_at'] = datetime.utcnow() - timedelta(seconds=1)
