...
class TestGameroomService:
    ...
    def test_create_gameroom(self):
        ...
        # 검증
        self.service.actions.create_gameroom.assert_called_once_with(test_data, test_guest_id)
        assert result == mock_room
    ...
    def test_toggle_ready_status(self):
        ...
        # 검증
        self.service.actions.toggle_ready_status.assert_called_once_with(room_id, guest_id)
