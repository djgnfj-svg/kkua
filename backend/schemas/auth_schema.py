...
class LoginRequest(BaseModel):
    ...
    nickname: Optional[str] = Field(None, min_length=1, max_length=20, description="Optional nickname for the guest")
...
class ProfileUpdateRequest(BaseModel):
    ...
    nickname: str = Field(..., min_length=1, max_length=20, description="New nickname for the guest")
...
class AuthStatusResponse(BaseModel):
    ...
    guest: Optional[ProfileResponse] = Field(None, description="Guest information if authenticated")
